...
def read_and_decode_angio_v0(image):
...
class Inference:
  def __init__(self, checkpoint):
    ...
    self.image = tf.placeholder(tf.float32, shape=(None, None))

    train_labels_one, train_data_one = read_and_decode_angio_v0(self.image)

    self.outputmap = FantinNetAngio_upscale_unet.build_feedfoward_ops(train_data_one, train_labels_one, False, IMAGE_SIZE,
