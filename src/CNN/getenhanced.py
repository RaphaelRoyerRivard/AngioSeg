...
def angio2fundus2enhanced(dirin, dirout, mode, grayscale, percrz):
    ...
    for j in range(len(filenames)):
        ...
        if percrz!=1.0:
            enhanced = misc.imresize(enhanced, percrz, interp='bilinear')
...
if __name__ == '__main__':
  angio2fundus2enhanced(sys.argv[1], sys.argv[2], sys.argv[3], int(sys.argv[4]), float(sys.argv[5]))